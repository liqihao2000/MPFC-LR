...
for kk = 1:length(M_array)
    ...
    for k = 1:maxIt
        ...
        [v2, r1,n_newton,n_cg] = MPFC_2D_CN_SAV(pde,domain,N,N,time,option);
...
%        &  1.00  &  2.00  &  78.61 
% dt     &   Error_L2	   &  Order 
% 5.0000e-01  1.1806e-01  0.00 
% 2.5000e-01  2.4341e-02  2.28 
% 1.2500e-01  5.9823e-03  2.02 
% 6.2500e-02  1.4906e-03  2.00 
% 3.1250e-02  3.7187e-04  2.00 
% 1.5625e-02  9.2855e-05  2.00 
% 7.8125e-03  2.3198e-05  2.00 
% 3.9063e-03  5.7976e-06  2.00 
