...
for kk = 1:length(M_array)
    ...
    for k = 1:maxIt
        ...
        [v2, r1,n_newton,n_cg] = MPFC_2D_BDF_SAV(pde,domain,N,N,time,option);
...
%        &  1.00  &  2.00  &  53.36 
%   dt     &   Error_L2	 &  Order 
% 5.0000e-01  9.5581e-02  0.00 
% 2.5000e-01  1.9911e-02  2.26 
% 1.2500e-01  4.4297e-03  2.17 
% 6.2500e-02  1.0772e-03  2.04 
% 3.1250e-02  2.6674e-04  2.01 
% 1.5625e-02  6.6358e-05  2.01 
% 7.8125e-03  1.6548e-05  2.00 
% 3.9063e-03  4.1316e-06  2.00 
