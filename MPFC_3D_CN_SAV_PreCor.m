function [phi, r0] = MPFC_3D_CN_SAV_PreCor(pde,domain,Nx,Ny,Nz,time,phi_p,option)
...
%% update phi0  
    ...
    psi1 = fun_psi(phi,phi0,psi0);        
    phi0 = phi;     
    
    if 1 == option.energyflag
        calculate_energy(out1,out2,hx,hy,hz,t,phi,psi1,r0,C0);
    end          
