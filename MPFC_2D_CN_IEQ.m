function [phi, U1,n_newton,n_cg] = MPFC_2D_CN_IEQ(pde,domain,Nx,Ny,time,option)
...
%% update phi0   
    ...
    if 1 == option.energyflag
        calculate_energy(out1,out2,hx,hy,t,phi1,psi1,U1,C0);
    end
